...
library.themes = {
    ...
    },
    {
        name = 'Pink UwU',
        theme = {
            ["Accent"]                    = fromrgb(227,0,255);
            ["Background"]                = fromrgb(18,18,18);
            ["Border"]                    = fromrgb(0,0,0);
            ["Border 1"]                  = fromrgb(227,0,255);
            ["Border 2"]                  = fromrgb(227,0,255);
            ["Border 3"]                  = fromrgb(255,255,255);
            ["Primary Text"]              = fromrgb(255,255,255);
...
function library:init()
    ...
    self.keyIndicator = self.NewIndicator({title = 'Your A Fatty', pos = newUDim2(0,15,0,325), enabled = true});
...
function library:CreateSettingsTab(menu)
    local settingsTab = menu:AddTab('  UI Settings  ', 999);
    ...
    mainSection:AddBind({text = 'Open / Close', flag = 'togglebind', nomouse = true, noindicator = true, bind = Enum.KeyCode.LeftControl, callback = function()
        library:SetOpen(not library.open)
    end});

    mainSection:AddButton({text = 'Join Discord', flag = 'joindiscord', confirm = true, callback = function()
        local res = syn.request({
            Url = 'https://discord.gg/sr8t9mM5uq',
            Method = 'POST',
            Headers = {
